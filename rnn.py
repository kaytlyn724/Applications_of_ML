...
class RNN(nn.Module):
    def __init__(self, input_feature_size, hidden_size, num_layers, num_classes, sequence_length):
        ...
        self.rnn = nn.RNN(input_feature_size, hidden_size, num_layers, batch_first=True) # TO DO !!!!!
        ...
        self.fc = nn.Linear(sequence_length * hidden_size, num_classes) # TO DO !!!!!
    ...
    def forward(self, x): # x: (batch_size, sequence_length, input_feature_size)
        ...
        h0 = torch.zeros(self.num_layers, x.size(0), self.hidden_size).to(x.device) # TO DO !!!!!
        ...
        out = out.reshape(out.shape[0], -1) # TO DO !!!!!
        out = self.fc(out) # TO DO !!!!!
