...
lin_reg_df = lin_reg_df.rename(columns={
    ...
    'X5 latitude': 'Lat',
    'X6 longitude': 'Long',
    'Y house price of unit area': 'Price_Area'}) #YOUR CODE HERE
lin_reg_df.head()
...
for rdm_st in random_state_list:
    ...
    RMSE = np.sqrt(MSE) #metrics.mean_squared_error(y_test, y_pred, squared=False) #YOUR CODE HERE -- remember RMSE is square root of MSE
