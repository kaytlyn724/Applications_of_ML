...
rf_clf = RandomForestClassifier(criterion="gini", min_samples_leaf=1, min_samples_split=10, max_features='sqrt', random_state=1) # YOUR CODE HERE
...
def plot_roc(rf_y_true, rf_probs):
    ...
    rf_fpr, rf_tpr, rf_threshold = roc_curve(rf_y_true, rf_probs[:, 1]) # YOUR CODE HERE
...
rf_probs = rf_clf.predict_proba(X_test)# This gives the classifiers' prediction probabilities for each class for the predicted samples
