...
# Features
X = pima_df.drop(columns='Outcome') # YOUR CODE HERE

# Target variable
y = pima_df['Outcome']# YOUR CODE HERE

# Split dataset into training set and test set - 80% training and 20% test --> try out other splits as well and check if you can get better results than the prescribed split of 80:20.
...
def plot_roc(dt_y_true, dt_probs):
    ...
    dtree_fpr, dtree_tpr, threshold = metrics.roc_curve(dt_y_true, dt_probs) # YOUR CODE HERE
    ...
    dtree_auc_val =  metrics.auc(dtree_fpr, dtree_tpr) # Put the AUC score here -- 1.5 of Gradescope tests
